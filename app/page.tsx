...
export default function Home() {
  ...
  useEffect(() => {
    ...
    const updateTelemetry = () => {
      setRoll((current) => {
        return current + (targetRoll.current - current) * 0.08;
      });

      setPitch((current) => {
        return current + (targetPitch.current - current) * 0.08;
      });

      animationFrame = window.requestAnimationFrame(updateTelemetry);
    };
  ...
  function handleHeroMouseMove(event: React.MouseEvent<HTMLElement>) {
    ...
    targetRoll.current = (x - 0.5) * 50;

    targetPitch.current = (0.5 - y) * 30;
  }
  ...
  return (
    <main className="min-h-screen bg-black text-white">
      ...
      >
        ...
        <div className="mx-auto grid min-h-[calc(100vh-80px)] w-full max-w-[1600px] items-center gap-16 lg:grid-cols-[1.2fr_0.8fr]">
              ...
              <div className="max-w-xl">
                ...
                <div className="mt-12 border-t border-white/10 pt-8">
                  ...
                  <div className="mt-6">
                    ...
                    <p className="mt-3 text-zinc-400">B.S. Informatics</p>
          ...
          <Reveal>
            <div className="mb-20">
              ...
              <p className="mt-6 max-w-lg text-lg leading-8 text-zinc-500">
                A path through communications, technical systems, UAVs,
                robotics, and autonomous aircraft.
              </p>
            </div>
          </Reveal>
